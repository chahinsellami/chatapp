...
**Window 2 (User B):** 4. Type "Hi back from User B!" and send

**Window 1 (User A):** 5. **Expected Result**: ✅ Message appears instantly
...
**Window 2 (User B):** 2. **Expected Result**: ✅ See "User A is typing..." below messages

**Window 1:** 3. Stop typing for 2+ seconds

**Window 2:** 4. **Expected Result**: ✅ Typing indicator disappears
...
**Window 2 (User B):** 5. **Expected Result**: ✅ See "Incoming Voice Call" modal 6. Click "Accept" 7. **Expected Result**: ✅ Browser asks for mic permission → Click "Allow" 8. **Expected Result**: ✅ Call connects, you should hear each other!

**Both Windows:** 9. Try the 🎤 Mute button 10. **Expected Result**: ✅ Other person can't hear you when muted 11. Click "End Call" 12. **Expected Result**: ✅ Call ends, modal closes
...
**Window 2 (User B):** 4. **Expected Result**: ✅ See "Incoming Video Call" modal 5. Click "Accept" 6. **Expected Result**: ✅ Browser asks for camera+mic → Click "Allow"

**Both Windows:** 7. **Expected Result**: ✅ See remote video (fullscreen) and local video (small box) 8. Try 📹 Camera button 9. **Expected Result**: ✅ Your video turns off/on 10. Try 🎤 Mute button 11. Try "End Call" 12. **Expected Result**: ✅ Call ends, cameras stop
...
**Window 1 (User A):** 2. Try sending a message 3. **Expected Result**: ✅ Message saves to database but receiver is offline 4. Check terminal: Should show `❌ Receiver user-B not connected`

**Window 2 (User B):** 5. Open browser again, login, go to Messenger 6. **Expected Result**: ✅ See the message User A sent while offline
